        ...
        try {
            ...
            if ($socialLoginServices) {
                foreach ($socialLoginServices as $socialLoginService) {
                    ...
                    } elseif ($socialLoginService['status'] == true && $socialLoginService['login_medium'] == 'twitter') {
                        $twitter_config = array(
                            'client_id' => $socialLoginService['client_id'],
                            'client_secret' => $socialLoginService['client_secret'],
                            'redirect' => url('customer/auth/login/twitter/callback'),
                        );
                        Config::set('services.twitter', $twitter_config);
                    }
                }
            }
