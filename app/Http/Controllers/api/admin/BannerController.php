...
class BannerController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        return $this->sendResponse(message: 'Banner added successfully!');
    }
    ...
    public function update(Request $request)
    {
        ...
        // return back();
        return $this->sendResponse(message: 'Banner updated successfully!');
    }
    ...
    public function delete(Request $request)
    {
        ...
        $br->delete();
        // return response()->json();
        return $this->sendResponse(message: 'Banner deleted successfully!');
    }
}
