...
class LanguageController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        return $this->sendResponse(message: 'Language Added!');
    }
    ...
    public function update_status(Request $request)
    {
        ...
        return $this->sendResponse(payload: $businessSetting);
    }
    ...
    public function update_default_status(Request $request)
    {
        ...
        return $this->sendResponse(message: 'Default Language Changed!');
    }
    ...
    public function translate($lang)
    {
        ...
        return $this->sendResponse(payload: compact('lang', 'lang_data'));
    }
