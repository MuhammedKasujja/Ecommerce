...
class BusinessSettingsController extends Controller
{
    ...
    public function currency_symbol_position($side)
    {
        ...
        return $this->sendResponse(message: 'Symbol position is ' . $side);
    }
    ...
    public function social_media_store(Request $request)
    {
        ...
        $social_media->save();
        return $this->sendResponse(message: 'Social media settings updated');
    }
    ...
    public function social_media_update(Request $request)
    {
        ...
        $social_media->link = $request->link;
        $social_media->save();
        return $this->sendResponse(message: 'Social media account added');
    }
    ...
    public function social_media_status_update(Request $request)
    {
        ...
        return $this->sendResponse(message: 'Social media status updated');
    }

    public function terms_condition()
    {
        $terms_condition = BusinessSetting::where('type', 'terms_condition')->first();
        return $this->sendResponse(payload: $terms_condition);
    }
    ...
    public function updateTermsCondition(Request $data)
    {
        ...
        return $this->sendResponse(message: 'Terms and Condition Updated successfully!');
    }

    public function privacy_policy()
    {
        $privacy_policy = BusinessSetting::where('type', 'privacy_policy')->first();
        return $this->sendResponse(payload: $privacy_policy);
    }
    ...
    public function privacy_policy_update(Request $data)
    {
        ...
        return $this->sendResponse(message: 'Privacy policy Updated successfully!');
    }
    ...
    public function updateCompany(Request $data)
    {
        ...
        return $this->sendResponse(message: 'Company Updated successfully!');
    }
    ...
    public function updateCompanyEmail(Request $data)
    {
        ...
        return $this->sendResponse(message: 'Company Email Updated successfully!');
    }

    public function updateCompanyCopyRight(Request $request)
    {
        try {
            ...
            BusinessSetting::where('type', 'company_copyright_text')->update(['value' => $request->company_copyright_text]);
            return $this->sendResponse(message: 'Company Copy Right Updated successfully!');
        } catch (\Throwable $ex) {
    ...
    public function shop_banner(Request $request)
    {
        ...
        return $this->sendResponse(message: 'Banner image updated successfully!');
    }
    ...
    public function update(Request $request, $name)
    {
        ...
        return $this->sendResponse(message: 'App Store Updated successfully');
    }
    ...
    public function updateCompanyPhone(Request $request)
    {
        try {
            ...
            return $this->sendResponse(message: 'Company Phone Updated successfully!');
        } catch (\Exception $ex) {
            return $this->sendError($ex->getMessage());
        }
    }

    public function uploadWebLogo(Request $request)
    {
        $img = BusinessSetting::where(['type' => 'company_web_logo'])->pluck('value')[0];
        if ($request->image) {
            $img = ImageManager::update('company/', $img, 'png', $request->file('image'));
        }

        BusinessSetting::where(['type' => 'company_web_logo'])->update([
            'value' => $img,
        ]);
        return $this->sendResponse(message: 'Web logo updated successfully');
    }
    ...
    public function uploadFooterLog(Request $data)
    {
        ...
        return $this->sendResponse(message: 'Footer Logo updated successfully!');
    }
    ...
    public function uploadFavIcon(Request $data)
    {
        ...
        return $this->sendResponse(message: 'Fav Icon updated successfully!');
    }
    ...
    public function uploadMobileLogo(Request $data)
    {
        ...
        return $this->sendResponse(message: 'Mobile app logo updated successfully');
    }
    ...
    public function update_colors(Request $request)
    {
        ...
        return $this->sendResponse(message: 'Color updated!');
    }
    ...
    public function update_fcm(Request $request)
    {
        ...
        return $this->sendResponse(message: 'Settings updated!');
    }
    ...
    public function update_fcm_messages(Request $request)
    {
        ...
        return $this->sendResponse(message: 'Message updated!');
    }
    ...
    public function seller_settings()
    {
        ...
        return $this->sendResponse(payload: compact('sales_commission', 'seller_registration'));
    }
    ...
    public function sales_commission(Request $data)
    {
        try {
            ...
            return $this->sendResponse(payload: 'Sales commission Updated successfully!');
        } catch (\Exception $ex) {
            return $this->sendError($ex->getMessage());
        }
    }
    ...
    public function seller_registration(Request $data)
    {
        ...
        return $this->sendResponse(message: 'Seller registration Updated successfully!');
    }
    ...
    public function update_language(Request $request)
    {
        ...
        return $this->sendResponse(message: 'Language  updated!');
    }
    ...
    public function updateSocialLogin($service, Request $request)
    {
        ...
        return $this->sendResponse(message: $service . ' credentials  updated!');
    }
}
