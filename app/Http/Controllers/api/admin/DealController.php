...
class DealController extends Controller
{
    ...
    public function flash_submit(Request $request)
    {
        ...
        return $this->sendResponse(message: 'Deal added successfully!');
    }

    public function edit($deal_id)
    {
        $deal = FlashDeal::find($deal_id);
        return $this->sendResponse(payload: $deal);
    }
    ...
    public function update(Request $request, $deal_id)
    {
        ...
        return $this->sendResponse(message: 'Deal updated successfully!');
    }
    ...
    public function status_update(Request $request)
    {
        ...
        return $this->sendResponse(message: 'Deal status updated');
    }
    ...
    public function featured_update(Request $request)
    {
        ...
        return $this->sendResponse(message: 'Featured Deal updated');
    }
    ...
    public function feature_index(Request $request)
    {
        ...
        return $this->sendResponse(payload: $flash_deals);
    }
    ...
    public function add_product_submit(Request $request, $deal_id)
    {
        ...
        return $this->sendResponse(message: 'Flash deal added');
    }

    public function delete_product($deal_product_id)
    {
        FlashDealProduct::where(['id' => $deal_product_id])->delete();
        return $this->sendResponse(message: 'Flash deal deleted');
    }
    ...
    public function day_status_update(Request $request)
    {
        ...
        return $this->sendResponse(message: 'Deal of day status updated');
    }
    ...
    public function day_delete($id)
    {
        ...
        return $this->sendResponse(message: 'Deal removed successfully!');
    }
}
