...
class ProductController extends BaseController
{
    public function add_new()
    {
        ...
        return $this->sendResponse(payload: compact('cat', 'br'));
    }
    ...
    public function approve_status(Request $request)
    {
        ...
        return $this->sendResponse(payload: ['status' => $product['request_status']]);
    }
    ...
    public function deny(Request $request)
    {
        ...
        return $this->sendResponse(payload: ['status' => 2]);
    }
    ...
    public function view($id)
    {
        ...
        return $this->sendResponse(payload: compact('product', 'reviews'));
    }
    ...
    public function store(Request $request)
    {
        ...
        return $this->sendResponse(message: 'Product added successfully!');
        // }
    }
    ...
    function list(Request $request, $type)
    {
        ...
        if ($type == 'in_house') {
            ...
            $products = Product::where(['added_by' => 'seller'])->where('request_status', $request->status);
        }
        ...
        return $this->sendResponse(message: compact('products', 'search', 'request_status'));
    }
    ...
    public function status_update(Request $request)
    {
        ...
        $product->save();
        return $this->sendResponse(payload: ['status' => $success]);
    }
    ...
    public function get_categories(Request $request)
    {
        ...
        return $this->sendResponse(payload: ['select_tag' => $res]);
    }
    ...
    public function sku_combination(Request $request)
    {
        ...
        $combinations = Helpers::combinations($options);
        return $this->sendResponse(payload: compact('combinations', 'unit_price', 'colors_active', 'product_name'));
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        return $this->sendResponse(message: 'Product updated successfully.');
        // }
    }
    ...
    public function remove_image(Request $request)
    {
        ...
        if (count(json_decode($product['images'])) < 2) {
            return $this->sendError('You cannot delete all images!');
        }
        ...
        return $this->sendResponse(message: 'Product image removed successfully!');
    }
    ...
    public function delete($id)
    {
        ...
        return $this->sendResponse(message: 'Product removed successfully!');
    }
    ...
    public function bulk_import_data(Request $request)
    {
        try {
            ...
            return $this->sendError('You have uploaded a wrong format file, please upload the right file.');
        }
        ...
        foreach ($collections as $collection) {
            foreach ($collection as $key => $value) {
                if ($value === "" && !in_array($key, $skip)) {
                    return $this->sendError('Please fill all the required fields');
                }
            }
        ...
        return $this->sendResponse(payload: count($data) . ' - Products imported successfully!');
    }
