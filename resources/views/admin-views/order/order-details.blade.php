                                    ...
                                    @if($detail->product->added_by=='admin')
                                        <div class="row">
                                            <img
                                                ...
                                                src="{{asset('storage/company/'.\App\Models\BusinessSetting::where(['type' => 'company_web_logo'])->first()->value)}}"
                                                alt="Image">
                                            <p class="sellerName">
                                                <a style="color: black;"
                                                   href="javascript:">
                                    ...
                                    @else
                                        <div class="row">
                                            <img
                                                class="avatar-img" style="width: 55px;height: 55px; border-radius: 50%;"
                                                onerror="this.src='{{asset('assets/front-end/img/image-place-holder.png')}}'"
                                                src="{{asset('storage/shop/'.\App\Models\Shop::where('seller_id','=',$detail->seller_id)->first()->image)}}"
                                                alt="Image">
                                            <p class="sellerName">
                                                <a style="color: black;"
                                        ...
                                        @php($seller = App\Models\Seller::with('shop')->find($detail->seller_id))
