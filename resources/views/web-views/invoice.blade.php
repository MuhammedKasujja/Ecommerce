        ...
        <table style="width: 100%">
            <tr>
                <th class="content-position-y bg-primary"
                    ...
                    <div class="text-white" style="padding-top:5px; padding-bottom:2px;"><i  class="fa fa-phone text-white"></i> Phone : {{\App\Models\BusinessSetting::where('type','company_phone')->first()->value}}</div>
